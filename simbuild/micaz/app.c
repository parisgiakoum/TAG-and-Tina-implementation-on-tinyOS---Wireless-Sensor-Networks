...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f93cdbedcf8, const void *arg_0x7f93cdbec020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f93cdb6c618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f93cd923020), 
int (*key_eq_fn)(void *arg_0x7f93cd923798, void *arg_0x7f93cd923a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f93cd71f610, int arg_0x7f93cd71f878);
static double RandomUniform(void );
...
uint16_t SRTreeC__measurement[1000];
...
static inline message_t *SRTreeC__RoutingReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(63U, "SRTreeC", "### RoutingReceive.receive() start ##### \n");
  sim_log_debug(64U, "SRTreeC", "Something received!!!  from %u \n", msource);
...
#line 227
  ...
  if (enqueueDone == SUCCESS) 
  ...
  else 
    {
      ...
      sim_log_debug(65U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }

  sim_log_debug(66U, "SRTreeC", "### RoutingReceive.receive() end ##### \n");
  return msg;
}
...
static inline message_t *SRTreeC__MeasReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(87U, "SRTreeC", "### MeasReceive.receive() start ##### \n");
  sim_log_debug(88U, "SRTreeC", "Some measurement received!!!  from %u \n", msource);
...
#line 411
  ...
  if (enqueueDone == SUCCESS) 
  ...
  else 
    {
      ...
      sim_log_debug(89U, "SRTreeC", "MeasMsg enqueue failed!!! \n");
    }

  sim_log_debug(90U, "SRTreeC", "### MeasReceive.receive() end ##### \n");
  return msg;
}
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f93cd335908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f93cd335908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f93cd335908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f93cd334480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f93cd334480, msg, payload, len);
#line 78
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(91U, "SRTreeC", "sendRoutingTask(): Q is empty!\n");
      return;
    }
  ...
  sendDone = SRTreeC__RoutingAMSend__send(AM_BROADCAST_ADDR, &SRTreeC__radioRoutingSendPkt[sim_node()], sizeof(RoutingMsg ));
  ...
  if (len == sizeof(RoutingMsg )) 
    {
      ...
      sim_log_debug(95U, "SRTreeC", "receiveRoutingTask(): source= %d , depth= %d \n", msource, __nesc_ntoh_uint8(mpkt->depth.nxdata));
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
        {
          ...
          sim_log_debug(96U, "RoutingMsg", "New parent for NodeID= %d : curdepth= %d , parentID= %d \n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__parentID[sim_node()]);
      ...
      else 
        {
          ...
          sim_log_debug(97U, "SRTreeC", "NodeID= %d : Already has a parent: curdepth= %d, parentID= %d \n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()], SRTreeC__parentID[sim_node()]);
        }
    }
  else 
    {
...
static inline void SRTreeC__sendMeasTask__runTask(void )
{
  ...
  if (SRTreeC__MeasSendQueue__empty()) 
    {
      sim_log_debug(99U, "SRTreeC", "sendMeasTask(): Q is empty!\n");
      return;
    }
  ...
  if (mlen != sizeof(MeasMsg )) 
    {
      sim_log_debug(100U, "SRTreeC", "\t\t sendMeasTask(): Unknown message!!\n");
      return;
    }

  sim_log_debug(101U, "SRTreeC", " sendMeasTask(): mlen = %u  sum= %d count= %d max=%d \n", mlen, __nesc_ntoh_uint16(mpayload->sum.nxdata), __nesc_ntoh_uint8(mpayload->count.nxdata), __nesc_ntoh_uint8(mpayload->max.nxdata));
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(102U, "SRTreeC", "sendMeasTask(): Send measure returned success!!!\n");
    }
  else 
    {

      sim_log_debug(103U, "SRTreeC", "send measure failed!!!\n");
    }
}
...
#line 585
  ...
  sim_log_debug(104U, "SRTreeC", "receiveMeasTask(): len=%u \n", len);


  if (len == sizeof(MeasMsg )) 
    {

      MeasMsg *mr = (MeasMsg *)SRTreeC__MeasPacket__getPayload(&radioMeasRecPkt, len);

      sim_log_debug(105U, "SRTreeC", "MeasMsg received from %d !!! \n", msource);
          ...
          if (__nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].childID.nxdata) == msource || __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].childID.nxdata) == 0) 
            {
              ...
              __nesc_hton_uint16(SRTreeC__children[sim_node()][i].sum.nxdata, __nesc_ntoh_uint16(mr->sum.nxdata));
              __nesc_hton_uint8(SRTreeC__children[sim_node()][i].count.nxdata, __nesc_ntoh_uint8(mr->count.nxdata));
              __nesc_hton_uint8(SRTreeC__children[sim_node()][i].max.nxdata, __nesc_ntoh_uint8(mr->max.nxdata));

              sim_log_debug(106U, "Measurements", "Received from childID: %d values - sum:%d, count: %d, max: %d\n", __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].childID.nxdata), __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].sum.nxdata), __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].count.nxdata), __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].max.nxdata));
  ...
  else 
    {
      ...
      sim_log_debug(107U, "SRTreeC", "receiveMeasTask():Empty message!!! \n");
      return;
    }
}
      ...
      for (i = 0; i < MAX_CHILDREN; i++) 
        {
          ...
          sim_log_debug(49U, "Tests", "Init child: %d, childID: %d, sum: %d, count: %d, max: %d\n", i, __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].childID.nxdata), __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].sum.nxdata), __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].count.nxdata), __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].max.nxdata));
        }
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f93cd3366e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f93cd3366e8, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f93ccc1de18, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f93ccc1de18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f93ccc1de18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f93cd5f9108){
#line 75
  switch (arg_0x7f93cd5f9108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f93cd5f9108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f93ccc1b020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f93ccc1b020, addr, msg, len);
#line 80
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      sim_log_debug(53U, "RoutingMsg", "##################################### \n");
      sim_log_debug(54U, "RoutingMsg", "#######   ROUND   %u    ############## \n", SRTreeC__roundCounter[sim_node()]);
      sim_log_debug(55U, "RoutingMsg", "#####################################\n");
    }
...
static inline void SRTreeC__RoundTimer__fired(void )
{
  ...
  if (TOS_NODE_ID == 0) 
    {
      SRTreeC__roundCounter[sim_node()]++;
      sim_log_debug(67U, "Measurements", "##################################### \n");
      sim_log_debug(68U, "Measurements", "#######   ROUND   %u    ############## \n", SRTreeC__roundCounter[sim_node()]);
      sim_log_debug(69U, "Measurements", "#####################################\n");
    }
}
...
#line 265
  ...
  if (!SRTreeC__FinishedRouting[sim_node()]) 
    {
      sim_log_debug(70U, "RoutingMsg", "FinishedRouting!\n");
    ...
    {
      sim_log_debug(71U, "Measurements", "NodeID = %d curdepth= %d\n", TOS_NODE_ID, SRTreeC__curdepth[sim_node()]);


      if (TOS_NODE_ID != 0) 
        {
          sim_log_debug(72U, "Measurements", "Starting Data transmission to parent!\n");
        }

      sim_log_debug(73U, "SRTreeC", "SendMeasTimer fired!\n");


      SRTreeC__measurement[sim_node()] = SRTreeC__Random__rand16() % 50;
      sim_log_debug(74U, "Measurements", "measurement is: %d\n", SRTreeC__measurement[sim_node()]);


      if (SRTreeC__MeasSendQueue__full()) 
        {
          sim_log_debug(75U, "SRTreeC", "MeasSendQueue full!\n");
          return;
        }


      measpkt = (MeasMsg *)SRTreeC__MeasPacket__getPayload(&tmp, sizeof(MeasMsg ));

      if (measpkt == (void *)0) 
        {
          sim_log_debug(76U, "SRTreeC", "SendMeasTimer.fired(): No valid payload... \n");
          return;
        }
      ...
      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
        {
          ...
          for (i = 0; i < MAX_CHILDREN && __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].childID.nxdata) != 0; i++) 
            {
              sim_log_debug(77U, "Measurements", "ChildID: %d has sum: %d, count: %d and max: %d\n", __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].childID.nxdata), __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].sum.nxdata), __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].count.nxdata), __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].max.nxdata));

              sum += __nesc_ntoh_uint16(SRTreeC__children[sim_node()][i].sum.nxdata);
              count += __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].count.nxdata);
              max = max > __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].max.nxdata) ? max : __nesc_ntoh_uint8(SRTreeC__children[sim_node()][i].max.nxdata);
            }
          sim_log_debug(78U, "Measurements", "Node has sum: %d, count: %d, max: %d\n", sum, count, max);
        }
#line 332
        __nesc_atomic_end(__nesc_atomic); }
      ...
      if (TOS_NODE_ID == 0) 
        {
          avg = (float )sum / count;
          sim_log_debug(79U, "Measurements", "\n");
          sim_log_debug(80U, "Measurements", "FINAL RESULTS: AVG: %.2f , Max: %d\n", avg, max);
          sim_log_debug(81U, "Measurements", "\n");
        }
      else 
        {
          ...
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
            {
              __nesc_hton_uint16(measpkt->sum.nxdata, sum);
              __nesc_hton_uint8(measpkt->count.nxdata, count);
              __nesc_hton_uint8(measpkt->max.nxdata, max);
            }
#line 350
            __nesc_atomic_end(__nesc_atomic); }

          sim_log_debug(82U, "SRTreeC", "Sending MeasMsg... \n");

          SRTreeC__MeasAMPacket__setDestination(&tmp, SRTreeC__parentID[sim_node()]);
          SRTreeC__MeasPacket__setPayloadLength(&tmp, sizeof(MeasMsg ));
              ...
              if (SRTreeC__MeasSendQueue__size() == 1) 
                {
                  ...
                  sim_log_debug(83U, "SRTreeC", "SendMeasTask() posted!!\n");
                  SRTreeC__sendMeasTask__postTask();
                }

              sim_log_debug(84U, "SRTreeC", "MeasMsg enqueued successfully in MeasSendQueue!!!\n");
            }
          else 
            {

              sim_log_debug(85U, "SRTreeC", "MeasMsg failed to be enqueued in MeasSendQueue!!!");
            }
        }
    }
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f93cccc0da0){
#line 83
  switch (arg_0x7f93cccc0da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f93cccc0da0);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(253U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(252U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(249U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(250U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(242U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(232U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(237U, "HplAtm128Timer0AsyncP", "TIFR is %hhx\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x36]);
          sim_log_debug(238U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(239U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(244U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
static void SRTreeC__MeasAMSend__sendDone(message_t *msendDonesg, error_t err)
{
  ...
  sim_log_debug(86U, "SRTreeC", "A Measure package sent... %s \n", err == SUCCESS ? "True" : "False");
...
#line 285
  ...
  sim_log_debug(241U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(247U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(227U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(228U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(229U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(230U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(248U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(251U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(240U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 91
{
  ...
  sim_log_debug(254U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 2) {
      ...
      sim_log_debug(255U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(256U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 2;
      ...
      sim_log_debug(257U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
