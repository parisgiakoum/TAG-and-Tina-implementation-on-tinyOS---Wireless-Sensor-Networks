...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7fbeb770ccf8, const void *arg_0x7fbeb770b020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7fbeb768b618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fbeb7442020), 
int (*key_eq_fn)(void *arg_0x7fbeb7442798, void *arg_0x7fbeb7442a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fbeb723e610, int arg_0x7fbeb723e878);
static double RandomUniform(void );
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fbeb6e81a90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fbeb6e81a90) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fbeb6e81a90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fbeb6e7f670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fbeb6e7f670, msg, payload, len);
#line 78
...
static inline void SRTreeC__sendNotifyTask__runTask(void )
{
  ...
  if (SRTreeC__NotifySendBusy[sim_node()] == TRUE) 
    {
      sim_log_debug(75U, "SRTreeC", "sendNotifyTask(): NotifySendBusy= TRUE!!!\n");
  ...
  if (mlen != sizeof(NotifyParentMsg )) 
    {
      sim_log_debug(76U, "SRTreeC", "\t\t sendNotifyTask(): Unknown message!!\n");
  ...
  sim_log_debug(77U, "SRTreeC", " sendNotifyTask(): mlen = %u  senderID= %u \n", mlen, __nesc_ntoh_uint16(mpayload->senderID.nxdata));
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(78U, "SRTreeC", "sendNotifyTask(): Send returned success!!!\n");
    }
  else 
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
        {
          ...
          sim_log_debug(82U, "SRTreeC", "receiveRoutingTask():NotifyParentMsg sending to node= %d... \n", SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(83U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!");
          ...
          if (SRTreeC__curdepth[sim_node()] > __nesc_ntoh_uint8(mpkt->depth.nxdata) + 1 || __nesc_ntoh_uint16(mpkt->senderID.nxdata) == SRTreeC__parentID[sim_node()]) 
            {
              ...
              sim_log_debug(84U, "SRTreeC", "NotifyParentMsg sending to node= %d... \n", oldparentID);
              ...
              if ((oldparentID < 65535 || oldparentID > 0) || oldparentID == SRTreeC__parentID[sim_node()]) 
                {
                  ...
                  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
                    {
                      sim_log_debug(85U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
              ...
              if (oldparentID != SRTreeC__parentID[sim_node()]) 
                {
                  ...
                  __nesc_hton_uint8(m->depth.nxdata, SRTreeC__curdepth[sim_node()]);
                  __nesc_hton_uint16(m->parentID.nxdata, SRTreeC__parentID[sim_node()]);
                  sim_log_debug(86U, "SRTreeC", "receiveRoutingTask():NotifyParentMsg sending to node= %d... \n", SRTreeC__parentID[sim_node()]);
                  ...
                  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
                    {
                      sim_log_debug(87U, "SRTreeC", "receiveRoutingTask(): NotifyParentMsg enqueued in SendingQueue successfully!!! \n");
...
static inline void SRTreeC__receiveNotifyTask__runTask(void )
{
  ...
  sim_log_debug(89U, "SRTreeC", "ReceiveNotifyTask(): len=%u \n", len);
  ...
  if (len == sizeof(NotifyParentMsg )) 
    {
      ...
      sim_log_debug(90U, "SRTreeC", "NotifyParentMsg received from %d !!! \n", __nesc_ntoh_uint16(mr->senderID.nxdata));
...
#line 693
          ...
          sim_log_debug(91U, "SRTreeC", "Forwarding NotifyParentMsg from senderID= %d  to parentID=%d \n", __nesc_ntoh_uint16(m->senderID.nxdata), SRTreeC__parentID[sim_node()]);
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(92U, "SRTreeC", "receiveNotifyTask(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
              if (SRTreeC__NotifySendQueue__size() == 1) 
                {
                  SRTreeC__sendNotifyTask__postTask();
                }
    ...
    {
      sim_log_debug(93U, "SRTreeC", "receiveNotifyTask():Empty message!!! \n");
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fbeb6e8a948, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fbeb6e8a948, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fbeb678a318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fbeb678a318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fbeb678a318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fbeb7118108){
#line 75
  switch (arg_0x7fbeb7118108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fbeb7118108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fbeb6788488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fbeb6788488, addr, msg, len);
#line 80
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fbeb6821da0){
#line 83
  switch (arg_0x7fbeb6821da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fbeb6821da0);
#line 83
      break;
#line 83
    }
...
#line 91
{
  ...
  sim_log_debug(240U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 2) {
      ...
      sim_log_debug(241U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(242U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 2;
      ...
      sim_log_debug(243U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
